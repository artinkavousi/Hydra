...
var propsToBody = (options) => {
  ...
  const body = new Body(__spreadProps(__spreadValues({}, extra), {
...
function useBody(type, fn, argsFn, fwdRef, deps) {
    ...
    currentWorker.addBodies({
      props: props.map((_ref3) => {
        let _a = _ref3, {
          ...
          onCollideBegin,
          onCollideEnd
        } = _a, serializableProps = __objRest(_a, [
          "onCollide",
          "onCollideBegin",
          "onCollideEnd"
        ]);
  ...
  const api = (0, import_react.useMemo)(() => {
    ...
    const cache = {};
    return __spreadProps(__spreadValues({}, makeApi(void 0)), {
...
function useConstraint(type, bodyA, bodyB, optns, deps) {
  ...
  const api = (0, import_react.useMemo)(() => {
    ...
    if (type === "Hinge") {
      return __spreadProps(__spreadValues({}, enableDisable), {
...
function useRay(mode, options, callback, deps) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    worker.addRay({
      props: __spreadProps(__spreadValues({}, options), {
        mode
      }),
      uuid
    });
...
function PhysicsProvider(_ref) {
  ...
  const collideHandler = (_ref2) => {
    ...
    cb2 && cb2(__spreadValues({
      body: refs[body],
      contact: __spreadValues({
        bi: refs[bi],
        bj: refs[bj]
      }, contactRest),
      target: refs[target]
