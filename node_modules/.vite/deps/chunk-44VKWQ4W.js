...
// node_modules/@react-three/fiber/dist/index-136ca0b0.esm.js
    ...
    if (isEvent) {
      ...
      if (Array.isArray(value)) {
        ...
        if (!isColor && targetProp.setScalar)
          ...
          targetProp.set(value);
        const supportsColorManagement = ColorManagement;
...
function createRenderer(roots2, getEventPriority2) {
  ...
  function switchInstance(instance, type, newProps, fiber) {
    ...
    if (!parent)
      return;
    const newInstance = createInstance(type, newProps, (_instance$__r3f2 = instance.__r3f) == null ? void 0 : _instance$__r3f2.root);
...
var Canvas = React2.forwardRef(function Canvas2(_a, forwardedRef) {
  var _b = _a, {
    children,
    fallback,
    resize,
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-44VKWQ4W.js.map
